    ...
    <div className="flex-1 flex flex-col overflow-hidden bg-[#FAF9F6]">
      ...
      <div className="flex items-center justify-between px-4 md:px-6 py-3 border-b border-[#E3E0D8] bg-[#F5F3EE] flex-shrink-0 flex-wrap gap-2">
        <div>
          ...
          <p className="text-xs text-[#9CA3AF]">{data.nodes.length} concepts · {data.edges.length} connections</p>
        </div>
          ...
          {loading ? (
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-8">
              ...
              <p className="text-[#9CA3AF] text-sm max-w-xs">
                Generate a report and the knowledge graph will be built automatically from the AI intelligence captured.
              </p>
            </div>
          ) : (
            <ForceGraph2D
